...
mod tests {
    ...
    fn test_cmd_list_ctx() {
        ...
        let ref_ctx_variables: IndexMap<String, String> = indexmap! {
            ...
            "BKRY_OPT_DIR".to_string() => BkryConstants::BKRY_OPT_DIR.to_string(),
            "BKRY_OPT_SCRIPTS_DIR".to_string() => BkryConstants::BKRY_OPT_SCRIPTS_DIR.to_string(),
            "BKRY_CFG_DIR".to_string() => BkryConstants::BKRY_CFG_DIR.to_string(),
            "BKRY_HOME_CFG_DIR".to_string() => format!("{}/.bakery", env_home()),
            "BKRY_BIN_DIR".to_string() => BkryConstants::BKRY_BIN_DIR.to_string(),
